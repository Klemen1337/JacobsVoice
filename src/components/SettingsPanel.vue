    ...
    <div class="settings-panel-inner">
      ...
      <div class="settings">
        ...
        <div class="form-group">
          ...
          <!-- <ion-range :ticks="true" :value="selectedRate" :snaps="true" :step="0.1" :min="0.0" :max="1.0"></ion-range> -->
        ...
        <div class="form-group">
          ...
          <!-- <ion-range :ticks="true" :value="selectedPitch" :snaps="true" :step="0.1" :min="0.0" :max="1.0"></ion-range> -->
